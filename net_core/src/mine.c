...
CL_MINE(proto_register)
CL_MINE(put_cmsg)
CL_MINE(qdisc_reset)
CL_MINE(__qdisc_run)
CL_MINE(refcount_dec_and_mutex_lock)
CL_MINE(release_sock)
CL_MINE(rhashtable_init)
CL_MINE(rhashtable_insert_slow)
CL_MINE(rhashtable_walk_enter)
CL_MINE(rhashtable_walk_exit)
CL_MINE(rhashtable_walk_next)
CL_MINE(rhashtable_walk_start_check)
CL_MINE(rhashtable_walk_stop)
CL_MINE(__rht_bucket_nested)
CL_MINE(rht_bucket_nested)
CL_MINE(rht_bucket_nested_insert)
...
CL_MINE(sock_efree)
CL_MINE(sock_i_ino)
CL_MINE(sock_init_data)
CL_MINE(sock_no_accept)
CL_MINE(sock_no_listen)
CL_MINE(sock_no_mmap)
CL_MINE(sock_no_sendpage)
CL_MINE(sock_no_shutdown)
CL_MINE(sock_no_socketpair)
CL_MINE(sock_omalloc)
CL_MINE(sock_prot_inuse_add)
